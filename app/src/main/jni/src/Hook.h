...
int (*get_CurHP)(void* player) = (int(*)(void *))getRealOffset(0xA48304);


bool (*get_IsSkyDashing)(void* player) = (bool(*)(void *))getRealOffset(0xA17A7C);

bool (*get_IsParachuting)(void* player) = (bool(*)(void *))getRealOffset(0xA1725C);

bool (*get_IsSkyDiving)(void* player) = (bool(*)(void *))getRealOffset(0xA17664);

bool (*get_IsDieing)(void* player) = (bool(*)(void *))getRealOffset(0xA0E51C);

bool (*IsSameTeam)(void* p1, void* p2) = (bool(*)(void*, void*))getRealOffset(0x24E1894);

bool (*IsVisible)(void* player) = (bool(*)(void *))getRealOffset(0xA182F0);

void* (*getPlayerByIndex)(void* match, uint8_t index) = (void*(*)(void *, uint8_t))getRealOffset(0x1A061EC); //public Player |`pUJY(byte cA^OZCl)

void* (*get_main)() = (void*(*)())getRealOffset(0x2684900); // UnityEngine.Camera

void* (*Component_get_transform)(void* comp) = (void*(*)(void *))getRealOffset(0x2689594);

Vector3 (*Transform_get_forward)(void* trans) = (Vector3(*)(void *))getRealOffset(0x2C95920);

void* (*GetLocalPlayer)(void* match) = (void*(*)(void *))getRealOffset(0x1A05D58); //public Player ^djkVy()
...
static void spofNick(void *players) {
    ...
    _spof_nick(players, U3DStr("MITOS TEAM"));
}
